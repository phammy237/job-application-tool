...
-- Verify as user A: user B's own select of A's row is blocked either way (see above), so
-- re-checking as B would prove nothing about whether the write itself was blocked.
set local request.jwt.claims to '{"sub":"a0000000-0000-4000-8000-000000000001","role":"authenticated"}';
select is(
  (select full_name from public.profiles where user_id = 'a0000000-0000-4000-8000-000000000001'),
  'User A',
