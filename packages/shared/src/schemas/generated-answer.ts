...
/**
 * Claude's raw-response contract, matching docs/AI_GROUNDING.md §3 exactly. This is what
 ...
 * is Claude's own self-report of anything in its draft it couldn't tie to a provided fact —
